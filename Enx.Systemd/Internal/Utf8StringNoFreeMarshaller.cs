...
/// <summary>
/// Custom UTF-8 string marshaller that avoids freeing unmanaged memory for "out" parameters.
/// Use <see cref="ManagedToUnmanagedIn"/> for optimized managed-to-unmanaged input marshalling.
/// </summary>
...
public static unsafe class Utf8StringNoFreeMarshaller
{
    ...
    /// <summary>
    /// No-op: unmanaged buffers are owned by native code for this marshaller.
    /// </summary>
